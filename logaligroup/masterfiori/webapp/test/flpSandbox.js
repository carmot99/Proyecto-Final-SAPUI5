			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterfiori-display": {
								"semanticObject": "masterfiori",
								"action": "display",
								"description": "Proyecto Final UI5",
								"title": "Proyecto Final",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterfiori",
									"url": sap.ui.require.toUrl("masterfiori")
								}
							}
						}
					}
